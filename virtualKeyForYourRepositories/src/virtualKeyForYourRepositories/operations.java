...
import java.io.IOException;
	...
	public class operations {
	    ...
	    private static final String WELCOME =
	            "\n********* LockedMe.com ********* "+
	              "\nDeveloped By : BHANUPRIYA";
	    private static final String mainmenu1=
	            "\nMain menu - Select the follwing option to experience lockedMe.com : \n"+
	                    "\n1:List the files which are in the directory"+
	                    "\n2:Choose the option to Add,Search or Delete"+
	                    "\n3:Exit the Program";
	    void Menu1() {
